    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Contact -->
         <div class="mt-4">
            ...
            <x-text-input id="contact" class="block mt-1 w-full" placeholder="e.g. 0123456789" type="text" name="contact" :value="old('contact')" required autofocus autocomplete="contact" />
